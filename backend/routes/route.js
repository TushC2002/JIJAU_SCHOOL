...
const { addStudentFees } = require('../controllers/student_controller.js'); // Import the new controller for student fees
...
// Add route for adding student fees
router.post('/AddStudentFees', addStudentFees);
