...
const ViewStudent = () => {
    ...
    const fields = password === ""
        ? { name, rollNum }
        : { name, rollNum,contactNo, totalFees, paidFees, dueFees, password }
    ...
    useEffect(() => {
        if (userDetails) {
            ...
            setTotalFees(userDetails.totalFees || 0);
            setPaidFees(userDetails.paidFees || 0);
            setDueFees(userDetails.dueFees || 0);
